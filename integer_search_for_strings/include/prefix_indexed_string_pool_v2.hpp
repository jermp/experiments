...
/* A pool of strings indexed by their integer prefixes of size (at most) 16. */

struct prefix_indexed_string_pool_v2 {
    ...
    struct builder {
        ...
        void build(prefix_indexed_string_pool_v2& pool) {
